...
def initialize_session_state():
    ...
    if 'generated' not in st.session_state:
        st.session_state['generated'] = ["Hello! Ask me anything about your PDFs."]
...
def create_conversational_chain(vector_store):
    llm = LlamaCpp(
        ...
        temperature=0.75,
        n_threads=6,   # adjust to number of CPU cores
        top_p=1,
        verbose=True,
        n_ctx=4096
    )
...
def main():
    ...
    st.title("📚 Multi-PDF ChatBot using Mistral-7B-Instruct")
